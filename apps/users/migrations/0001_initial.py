    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_user', models.CharField(blank=True, max_length=2, null=True, verbose_name=b'tipo de usuario', choices=[(b'1', b'Administrador'), (b'2', b'Directivo de Equipo'), (b'3', b'Arbitro')])),
